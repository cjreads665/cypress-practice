...
export default function GrudgeList(){
    ...
    return (
        <div style={{margin: '20px'}}>
            ...
            <Button onClick={addGrudge} data-test='add-grudge-btn' >
                Add Grudge
            </Button>
                    ...
                    grudges.length > 0 && (
                        grudges.map((g) => {
                           ...
                           <li key={g.id}>
                                ...
                                <Button data-test='remove-grudge-btn' onClick={() => deleteGrudge(g)}>
                                    X
                                </Button> 
                            </li>
                        )})
            ...
            {
                grudges.length > 0 && <Button data-test='clear-btn' onClick={clearGrudges}>Clear</Button>
            }
        </div>
    )
}